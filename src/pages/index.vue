<template>
  <div>
    <UPageHero title="Vue Starter Template"
    ...
    <UPageSection id="features" title="Everything you need to build modern Vue apps"
      ...
      :features="[{
        ...
        description: 'Pre-configured with TypeScript, Oxlint, Tailwind CSS, and Vite. Focus on building features, not setting up tooling.'
      }, {
